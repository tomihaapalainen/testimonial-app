      ...
      <div className="flex flex-col justify-center items-center mt-10 sm:mt-20">
        ...
        >
          ...
          <div className="w-full flex flex-col">
            <div>
              <label className="text-gray-700">Nimesi*</label>
            ...
            <div>
              <label className="text-gray-700">Tittelisi*</label>
              <div className="w-full border-b border-gray-300 rounded-sm focus-within:border-gray-600">
                <input
            ...
            <div>
              <label className="text-gray-700">Yrityksesi</label>
              <div className="w-full border-b border-gray-300 rounded-sm focus-within:border-gray-600">
                <input
          ...
          <div className="w-10/12 max-w-sm flex flex-col items-center mt-5 sm:mt-10 space-y-5 sm:space-y-10">
            <button
              type="submit"
              className="w-full flex justify-center px-5 py-3 font-bold text-white bg-gray-900 hover:bg-gray-700 hover:shadow-md"
            >
              Lähetä
            </button>
          </div>
        ...
        <button
          onClick={cancel}
          className="my-10 sm:my-20 px-5 py-2 text-gray-600 hover:text-gray-800 border border-gray-200 hover:border-gray-400 shadow-md"
        >
          <p>Peruuta</p>
        </button>
      </div>
